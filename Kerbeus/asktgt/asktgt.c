...
void coffee(char** argv, int argc, WCHAR** dispatch) {
    ...
    if (argc < 1) {
        ...
        "  - asktgt /user:USER /password:PASSWORD [/domain:DOMAIN] [/dc:DC] [/enctype:{rc4|aes256}] [/ptt] [/nopac] [/opsec]\n"
    ...
    // CHAR* param = "/user:administrator /password:admin@123 /domain:darkvortex.corp /enctype:rc4 /ptt";
